...
public class MenuResponsabile {
	
	public void gestisci()
	{
		int x;
		try {
			Responsabile tipo = new Responsabile();
			
			Scanner in = new Scanner(System.in);
			String sqlcommand = "select * from responsabile";
			String risultato="";
			String Matricola="";
            String Cognome="";
			String Nome="";
			...
			do
			{
			System.out.println("Gestione tabella Responsabile \nSelezionare una Operazione");
			...
			System.out.println("Immettere ID_Responsabile,Cognome, Nome, DatadiNascita, Datadi Assunzione,Stipendio, Residenza");
			...
			case 2: 
				risultato= tipo.Execquery(sqlcommand);
				System.out.println(risultato);
				System.out.println("Immettere ID_Responsabile ");
			...
			case 3: 
				risultato= tipo.Execquery(sqlcommand);
				System.out.println(risultato);
				System.out.println("Immettere ID_Responsabile campo e valore da aggiornare");
